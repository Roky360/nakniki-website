...
const getHeaders = (jwt, headers, params) => {
    return {
        headers: {
...
export const sendPost = async (uri, jwt, headers = {}, body = '', params = {}) => {
    return await axios.post(`${apiBase}${uri}`, body, getHeaders(jwt, headers, params));
}

export const sendPut = async (uri, jwt, headers = {}, body = '', params = {}) => {
    return await axios.put(`${apiBase}${uri}`, body, getHeaders(jwt, headers, params));
}
